...
### **📖 فهرست مطالب**  
1️⃣ [API Routes (مسیرهای API)](#-api-routes-مسیرهای-api)  
2️⃣ [اتصال به پایگاه داده](#-اتصال-به-پایگاه-داده)  
3️⃣ [Middleware در Next.js](#-middleware-در-nextjs)  
4️⃣ [استفاده از سرورهای خارجی (Serverless Functions)](#-استفاده-از-سرورهای-خارجی-serverless-functions)  
5️⃣ [سرور سفارشی با Express.js](#-اجرای-بکاند-به-روش-فول-استک-custom-server)  
6️⃣ [جمع‌بندی](#-جمعبندی)  
